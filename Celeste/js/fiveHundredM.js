class FiveHundredM extends Phaser.Scene
{
	constructor()
    {
        super({key:'500M'});
	...
	preload()
    {
        ...
        */
        ...
        // --- 100M Level: ---
        this.load.tilemapTiledJSON('500M_Level','500M_Level.json'); // HERE!!!!!
	...
	create()
    {
        ...
        this.map = this.add.tilemap('500M_Level'); // HERE!!!!!
        ...
        this.hero = new heroPrefab(this, 11, 84);
