class ThreeHundredM extends Phaser.Scene
{
	...
	preload()
    {
        ...
        */
        ...
        // --- 100M Level: ---
        this.load.tilemapTiledJSON('300M_Level','300M_Level.json'); // HERE!!!!!
	...
	create()
    {
        ...
        this.map = this.add.tilemap('300M_Level'); // HERE!!!!!
        ...
        this.hero = new heroPrefab(this, 11, 100);
