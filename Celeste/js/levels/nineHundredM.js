class NineHundredM extends Phaser.Scene
{
	constructor()
    {
        super({key:'900M'});
	...
	preload()
    {
        ...
        // --- Tilemap Json: ---
        this.load.tilemapTiledJSON('900M_Level','900M_Level.json');
        this.load.json('900M_Json','900M_Level.json');
	...
	create()
    {
        ...
        this.map = this.add.tilemap('900M_Level');
        ...
        this.data = this.cache.json.get('900M_Json');
        ...
        this.hero = new heroPrefab(this, 80, 368);
