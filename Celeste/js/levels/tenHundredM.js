class TenHundredM extends Phaser.Scene
{
	constructor()
    {
        super({key:'1000M'});
	...
	preload()
    {
        ...
        // --- Tilemap Json: ---
        this.load.tilemapTiledJSON('1000M_Level','1000M_Level.json');
        this.load.json('1000M_Json','1000M_Level.json');
        ...
        this.load.audio('blockBroken','blockBroken.wav');
    }
	...
	create()
    {
        ...
        this.map = this.add.tilemap('1000M_Level');
        ...
        this.data = this.cache.json.get('1000M_Json');
    ...
    loadSounds()
    {
        ...
        this.blockBroken = this.sound.add('blockBroken');
    }
